module dog_layer(ActionSel, DogPos_x, DogPos_y, x_pos, y_pos, pixel_clk, RqFLag0, r0, g0, b0);
    input [9:0]x_pos;
	input [8:0]y_pos;
	input pixel_clk;
	input [2:0] ActionSel;
	...
	assign next_y_disp=y_pos-DogPos_y;
        ...
        assign addr={next_y_disp[5:0],next_x_disp[5:0]};
	...
	assign RqFLag0=(next_x_pos>=DogPos_x)&&(next_x_pos<(DogPos_x+64))&&(next_y_pos>=DogPos_y)&&(next_y_pos<(DogPos_y+64)&&({r0,g0,b0}!= 24'hffffcc));
endmodule